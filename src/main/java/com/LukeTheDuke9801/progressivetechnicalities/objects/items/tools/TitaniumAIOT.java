...
public class TitaniumAIOT extends ToolItem {
	   ...
	   public TitaniumAIOT(IItemTier tier, int attackDamageIn, float attackSpeedIn, Item.Properties builder) {
	   ...
	   @Override
		public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
			if (KeyboardHelper.isHoldingShift()) {
				tooltip.add(new StringTextComponent("Functions as a pickaxe, shovel and axe"));
			}
