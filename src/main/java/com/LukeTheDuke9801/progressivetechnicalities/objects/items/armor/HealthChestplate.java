...
public class HealthChestplate extends ArmorItem{

	public HealthChestplate(EquipmentSlotType slot, Properties builder) {
	...
	public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
		if (KeyboardHelper.isHoldingShift()) {
			tooltip.add(new StringTextComponent("Grants regeneration III and saturation"));
		}
