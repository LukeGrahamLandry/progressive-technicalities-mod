...
public class JetPack1 extends ArmorItem{

	public JetPack1(EquipmentSlotType slot, Properties builder) {
	...
	public void onArmorTick(ItemStack stack, World world, PlayerEntity player) {
		if (KeyboardHelper.isHoldingSpace()) {
			player.setMotion(player.getMotion().getX(), Math.min(player.getMotion().getY() + 0.09D, 0.2D), player.getMotion().getZ());
