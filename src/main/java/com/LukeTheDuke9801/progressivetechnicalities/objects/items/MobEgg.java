...
public class MobEgg extends Item {
   private EntityType typeIn = null;

   public MobEgg(Item.Properties builder) {
      super(builder);
   }
   
   @Override
	public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
		if (KeyboardHelper.isHoldingShift() && this.typeIn != null) {
   ...
   public void setType(EntityType entity) {
	   this.typeIn = entity;
   }
   ...
   public ActionResultType onItemUse(ItemUseContext context) {
	   if (this.typeIn == null) return ActionResultType.PASS;
   ...
   public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand handIn) {
	   ...
	   if (this.typeIn == null) return ActionResult.resultPass(itemstack);
