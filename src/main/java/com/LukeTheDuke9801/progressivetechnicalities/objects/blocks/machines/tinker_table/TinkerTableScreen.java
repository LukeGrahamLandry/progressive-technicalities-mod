...
@OnlyIn(Dist.CLIENT)
public class TinkerTableScreen extends ContainerScreen<TinkerTableContainer> implements IContainerListener {
   private static final ResourceLocation ANVIL_RESOURCE = new ResourceLocation("textures/gui/container/anvil.png");
   private TextFieldWidget nameField;

   public TinkerTableScreen(TinkerTableContainer p_i51103_1_, PlayerInventory p_i51103_2_, ITextComponent p_i51103_3_) {
