...
@OnlyIn(Dist.CLIENT)
public class AlloyTableScreen extends ContainerScreen<AlloyTableContainer> implements IContainerListener {
   private static final ResourceLocation ANVIL_RESOURCE = new ResourceLocation("textures/gui/container/anvil.png");
   private TextFieldWidget nameField;

   public AlloyTableScreen(AlloyTableContainer p_i51103_1_, PlayerInventory p_i51103_2_, ITextComponent p_i51103_3_) {
