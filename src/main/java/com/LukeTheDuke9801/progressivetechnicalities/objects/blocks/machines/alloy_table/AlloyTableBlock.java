...
public class AlloyTableBlock extends FallingBlock {
	   ...
	   private static final TranslationTextComponent field_220273_k = new TranslationTextComponent("container.alloy_table");

	   public AlloyTableBlock(Block.Properties properties) {
	      super(properties);
	   ...
	   public INamedContainerProvider getContainer(BlockState state, World worldIn, BlockPos pos) {
	      return new SimpleNamedContainerProvider((p_220272_2_, p_220272_3_, p_220272_4_) -> {
	         return new AlloyTableContainer(p_220272_2_, p_220272_3_, IWorldPosCallable.of(worldIn, pos));
	      }, field_220273_k);
	   }
