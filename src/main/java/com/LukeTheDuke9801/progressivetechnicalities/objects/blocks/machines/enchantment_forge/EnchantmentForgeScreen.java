...
@OnlyIn(Dist.CLIENT)
public class EnchantmentForgeScreen extends ContainerScreen<EnchantmentForgeContainer> implements IContainerListener {
   private static final ResourceLocation ANVIL_RESOURCE = new ResourceLocation("textures/gui/container/anvil.png");
   private TextFieldWidget nameField;

   public EnchantmentForgeScreen(EnchantmentForgeContainer p_i51103_1_, PlayerInventory p_i51103_2_, ITextComponent p_i51103_3_) {
   ...
   protected void init() {
      ...
      this.nameField = new TextFieldWidget(this.font, i + 62, j + 24, 103, 12, I18n.format("container.enchantment_forge"));
