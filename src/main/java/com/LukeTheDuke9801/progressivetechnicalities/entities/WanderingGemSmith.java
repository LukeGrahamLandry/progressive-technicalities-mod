...
public class WanderingGemSmith extends AbstractVillagerEntity {
	   @Nullable
	   ...
	   @Override
		protected void populateTradeData() {
	     ...
	     this.addTrades(merchantoffers, sells, 5);  // idk what the 5 is for
	     this.addTrades(merchantoffers, buys, 5);
	      
	   }
		
		static final VillagerTrades.ITrade[] sells = new VillagerTrades.ITrade[]{
		...
		static final VillagerTrades.ITrade[] buys = new VillagerTrades.ITrade[]{
	   ...
	   protected void registerGoals() {
	      ...
	      this.goalSelector.addGoal(2, new WanderingGemSmith.MoveToGoal(this, 2.0D, 0.35D));
	      this.goalSelector.addGoal(3, new TemptGoal(this, 0.5D, false, Ingredient.fromItems(Items.EMERALD)));
	   ...
	   class MoveToGoal extends Goal {
	      final WanderingGemSmith traderEntity;
	      final double maxDistance;
	      final double speed;

	      MoveToGoal(WanderingGemSmith traderEntityIn, double distanceIn, double speedIn) {
	      ...
	      public void resetTask() {
	         ...
	         WanderingGemSmith.this.navigator.clearPath();
	      }
	      ...
	      public void tick() {
	         BlockPos blockpos = this.traderEntity.getWanderTarget();
	         if (blockpos != null && WanderingGemSmith.this.navigator.noPath()) {
	            if (this.isWithinDistance(blockpos, 10.0D)) {
	               ...
	               WanderingGemSmith.this.navigator.tryMoveToXYZ(vec3d1.x, vec3d1.y, vec3d1.z, this.speed);
	            } else {
	            	WanderingGemSmith.this.navigator.tryMoveToXYZ((double)blockpos.getX(), (double)blockpos.getY(), (double)blockpos.getZ(), this.speed);
	            }
	         }
