...
public class WandererVillageStructure extends Structure<NoFeatureConfig> {
    public WandererVillageStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config)
    {
        super(config);
    }
    ...
    {
        int maxDistance = FeatureInit.wandererVillageDistance.max;
        int minDistance = FeatureInit.wandererVillageDistance.min;
    ...
    {
        return ProgressiveTechnicalities.MOD_ID + ":wanderer_village";
    }
    ...
    {
        return WandererVillageStructure.Start::new;
    }
    ...
    public static class Start extends StructureStart
    {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn)
        {
            ...
            WandererVillagePieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);

            //Sets the bounds of the structure.
            this.recalculateStructureSize();

            //I use to debug and quickly find out if the structure is spawning or not and where it is.
            ProgressiveTechnicalities.LOGGER.debug("Wanderer Village at " + (blockpos.getX()) + " " + blockpos.getY() + " " + (blockpos.getZ()));
        }
