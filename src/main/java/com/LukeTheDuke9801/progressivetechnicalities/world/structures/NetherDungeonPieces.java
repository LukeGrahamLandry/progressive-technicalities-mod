...
public class NetherDungeonPieces {
    private static final ResourceLocation ALL = new ResourceLocation(ProgressiveTechnicalities.MOD_ID + ":nether_dungeon");
    ...
    public static void start(TemplateManager templateManager, BlockPos pos, Rotation rotation, List<StructurePiece> pieceList, Random random) {
        ...
        pieceList.add(new NetherDungeonPieces.Piece(templateManager, ALL, blockpos, rotation));
    }
    ...
    public static class Piece extends TemplateStructurePiece {
        ...
        public Piece(TemplateManager templateManagerIn, ResourceLocation resourceLocationIn, BlockPos pos, Rotation rotationIn) {
            super(FeatureInit.NETHER_DUNGEON_PIECE, 0);
            this.resourceLocation = resourceLocationIn;
            BlockPos blockpos = NetherDungeonPieces.OFFSET.get(resourceLocation);
        ...
        public Piece(TemplateManager templateManagerIn, CompoundNBT tagCompound) {
            super(FeatureInit.NETHER_DUNGEON_PIECE, tagCompound);
        ...
        public boolean func_225577_a_(IWorld worldIn, ChunkGenerator<?> p_225577_2_, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos chunkPos) {
            PlacementSettings placementsettings = (new PlacementSettings()).setRotation(this.rotation).setMirror(Mirror.NONE);
            BlockPos blockpos = NetherDungeonPieces.OFFSET.get(this.resourceLocation);
