...
public class NetherDungeonStructure extends Structure<NoFeatureConfig> {
    public NetherDungeonStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config)
    {
        super(config);
    }
    ...
    {
        return ProgressiveTechnicalities.MOD_ID + ":nether_dungeon";
    }
    ...
    {
        return NetherDungeonStructure.Start::new;
    }
    ...
    public static class Start extends StructureStart
    {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn)
        {
            ...
            NetherDungeonPieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);

            //Sets the bounds of the structure.
            this.recalculateStructureSize();

            //I use to debug and quickly find out if the structure is spawning or not and where it is.
            ProgressiveTechnicalities.LOGGER.debug("Nether Dungeon at " + (blockpos.getX()) + " " + blockpos.getY() + " " + (blockpos.getZ()));
        }
