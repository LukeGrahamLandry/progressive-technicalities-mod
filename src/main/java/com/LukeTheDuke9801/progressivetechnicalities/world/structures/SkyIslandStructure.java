...
public class SkyIslandStructure extends Structure<NoFeatureConfig> {
    public SkyIslandStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config)
    {
        super(config);
    }
    ...
    protected ChunkPos getStartPositionForPosition(ChunkGenerator<?> chunkGenerator, Random random, int x, int z, int spacingOffsetsX, int spacingOffsetsZ)
    {
        ...
        int maxDistance = FeatureInit.skyIslandDistance.max;
        int minDistance = FeatureInit.skyIslandDistance.min;
    ...
    {
        return ProgressiveTechnicalities.MOD_ID + ":sky_island";
    }
    ...
    {
        return SkyIslandStructure.Start::new;
    }
    ...
    public static class Start extends StructureStart
    {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn)
        {
            ...
            SkyIslandPieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);

            //Sets the bounds of the structure.
            this.recalculateStructureSize();

            //I use to debug and quickly find out if the structure is spawning or not and where it is.
            ProgressiveTechnicalities.LOGGER.debug("Sky Island at " + (blockpos.getX()) + " " + blockpos.getY() + " " + (blockpos.getZ()));
        }
