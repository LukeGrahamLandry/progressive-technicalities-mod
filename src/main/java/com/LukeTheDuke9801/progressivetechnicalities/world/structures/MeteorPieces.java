...
public class MeteorPieces {
    private static final ResourceLocation ALL = new ResourceLocation(ProgressiveTechnicalities.MOD_ID + ":meteor");
    private static final Map<ResourceLocation, BlockPos> OFFSET = ImmutableMap.of(ALL, new BlockPos(0, -3, 0)); // , RIGHT_SIDE, new BlockPos(0, 1, 0));
    ...
    public static void start(TemplateManager templateManager, BlockPos pos, Rotation rotation, List<StructurePiece> pieceList, Random random) {
        ...
        pieceList.add(new MeteorPieces.Piece(templateManager, ALL, blockpos, rotation));
    }
    ...
    public static class Piece extends TemplateStructurePiece {
        ...
        public Piece(TemplateManager templateManagerIn, ResourceLocation resourceLocationIn, BlockPos pos, Rotation rotationIn) {
            super(FeatureInit.METEOR_PIECE, 0);
            this.resourceLocation = resourceLocationIn;
            BlockPos blockpos = MeteorPieces.OFFSET.get(resourceLocation);
        ...
        public Piece(TemplateManager templateManagerIn, CompoundNBT tagCompound) {
            super(FeatureInit.METEOR_PIECE, tagCompound);
        ...
        protected void handleDataMarker(String function, BlockPos pos, IWorld worldIn, Random rand, MutableBoundingBox sbb) {
            if ("chest".equals(function)) {
                ...
                if (tileentity instanceof ChestTileEntity) {
                    ResourceLocation ltable = new ResourceLocation(ProgressiveTechnicalities.MOD_ID, "chest/meteor");
                    ((ChestTileEntity)tileentity).setLootTable(ltable, rand.nextLong());
                }

            }

            if ("ore".equals(function)) {
                // change to star stuff ore
                worldIn.setBlockState(pos, BlockInit.AIR_GEM_ORE.get().getDefaultState(), 3);
            }
        }
        ...
        public boolean create(IWorld worldIn, ChunkGenerator<?> p_225577_2_, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos chunkPos) {
            PlacementSettings placementsettings = (new PlacementSettings()).setRotation(this.rotation).setMirror(Mirror.NONE);
            BlockPos blockpos = MeteorPieces.OFFSET.get(this.resourceLocation);
