...
public class FeyHengeStructure extends Structure<NoFeatureConfig> {
    public FeyHengeStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config)
    {
        super(config);
    }
    ...
    protected ChunkPos getStartPositionForPosition(ChunkGenerator<?> chunkGenerator, Random random, int x, int z, int spacingOffsetsX, int spacingOffsetsZ)
    {
        ...
        int maxDistance = FeatureInit.feyHengeDistance.max;
        int minDistance = FeatureInit.feyHengeDistance.min;
    ...
    {
        return ProgressiveTechnicalities.MOD_ID + ":fey_henge";
    }
    ...
    {
        return FeyHengeStructure.Start::new;
    }
    ...
    public static class Start extends StructureStart
    {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn)
        {
            ...
            FeyHengePieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);

            //Sets the bounds of the structure.
            this.recalculateStructureSize();

            //I use to debug and quickly find out if the structure is spawning or not and where it is.
            ProgressiveTechnicalities.LOGGER.debug("Fey Henge at " + (blockpos.getX()) + " " + blockpos.getY() + " " + (blockpos.getZ()));
        }
