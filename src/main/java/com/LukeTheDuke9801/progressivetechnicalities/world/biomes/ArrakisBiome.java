...
public class ArrakisBiome extends Biome{
	public ArrakisBiome() {
	    ...
	    this.addSpawn(EntityClassification.MONSTER, new SpawnListEntry(ModEntityTypes.FREMAN, 1, 3, 6));
		...
		OreGen.generate(this, OreGen.SANDSTONE_FILLER, Blocks.SAND, 40, 0, 70, 50);
