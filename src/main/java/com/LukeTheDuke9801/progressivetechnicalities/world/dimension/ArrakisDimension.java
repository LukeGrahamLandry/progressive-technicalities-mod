...
public class ArrakisDimension extends Dimension{
	public ArrakisDimension(World world, DimensionType type) {
	...
	public ChunkGenerator<?> createChunkGenerator() {
		...
		settings.setDefaultBlock(Blocks.SANDSTONE.getDefaultState());
		SingleBiomeProviderSettings biomeProviderSettings = new SingleBiomeProviderSettings(world.getWorldInfo());
	    biomeProviderSettings.setBiome(BiomeInit.SAND_DUNES.get());
