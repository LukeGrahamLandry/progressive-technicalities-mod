...
public class BloodDimensionChunkGenerator extends NoiseChunkGenerator<BloodDimensionGenSettings> {
	...
	public BloodDimensionChunkGenerator(IWorld worldIn, BiomeProvider provider, BloodDimensionGenSettings settingsIn) {
