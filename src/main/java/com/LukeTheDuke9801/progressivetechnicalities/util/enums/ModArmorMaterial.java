...
public enum ModArmorMaterial implements IArmorMaterial {
	   ...
	   FEYSTEEL(ProgressiveTechnicalities.MOD_ID + ":feysteel", 33, new int[]{3, 6, 8, 3}, 20, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 2.0F, () -> {
	   ...
	   FIREGEM(ProgressiveTechnicalities.MOD_ID + ":firegem", 33, new int[]{3, 6, 8, 3}, 20, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 2.0F, () -> {
		   return Ingredient.fromItems(ItemInit.FIRE_GEM.get());}),
	   AIRGEM(ProgressiveTechnicalities.MOD_ID + ":airgem", 33, new int[]{3, 6, 8, 3}, 20, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 2.0F, () -> {
		   return Ingredient.fromItems(ItemInit.AIR_GEM.get());}),
	   WATERGEM(ProgressiveTechnicalities.MOD_ID + ":watergem", 33, new int[]{3, 6, 8, 3}, 20, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 2.0F, () -> {
		   return Ingredient.fromItems(ItemInit.WATER_GEM.get());}),
	   EARTHGEM(ProgressiveTechnicalities.MOD_ID + ":earthgem", 33, new int[]{3, 6, 8, 3}, 20, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 2.0F, () -> {
		   return Ingredient.fromItems(ItemInit.EARTH_GEM.get());}),
	   NYMPHARIUM(ProgressiveTechnicalities.MOD_ID + ":nympharium", 33, new int[]{3, 6, 8, 3}, 20, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 2.0F, () -> {
		  return Ingredient.fromItems(ItemInit.NYMPHARIUM_INGOT.get());});
