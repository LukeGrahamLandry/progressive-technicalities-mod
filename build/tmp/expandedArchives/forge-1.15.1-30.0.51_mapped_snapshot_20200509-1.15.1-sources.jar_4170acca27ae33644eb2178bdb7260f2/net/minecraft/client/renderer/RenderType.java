...
public abstract class RenderType extends RenderState {
   ...
   public static RenderType getEntityCutoutNoCull(ResourceLocation locationIn) {
      RenderType.State rendertype$state = RenderType.State.getBuilder().texture(new RenderState.TextureState(locationIn, false, false)).transparency(NO_TRANSPARENCY).diffuseLighting(DIFFUSE_LIGHTING_ENABLED).alpha(DEFAULT_ALPHA).cull(CULL_DISABLED).lightmap(LIGHTMAP_ENABLED).overlay(OVERLAY_ENABLED).build(true);
   ...
   public static RenderType getEntityTranslucent(ResourceLocation locationIn) {
      RenderType.State rendertype$state = RenderType.State.getBuilder().texture(new RenderState.TextureState(locationIn, false, false)).transparency(TRANSLUCENT_TRANSPARENCY).diffuseLighting(DIFFUSE_LIGHTING_ENABLED).alpha(DEFAULT_ALPHA).cull(CULL_DISABLED).lightmap(LIGHTMAP_ENABLED).overlay(OVERLAY_ENABLED).build(true);
   ...
   public static RenderType getOutline(ResourceLocation locationIn) {
      return makeType("outline", DefaultVertexFormats.POSITION_COLOR_TEX, 7, 256, RenderType.State.getBuilder().texture(new RenderState.TextureState(locationIn, false, false)).cull(CULL_DISABLED).depthTest(DEPTH_ALWAYS).alpha(DEFAULT_ALPHA).texturing(OUTLINE_TEXTURING).fog(NO_FOG).target(OUTLINE_TARGET).build(false));
   }
   ...
   public static final class State {
      ...
      private State(RenderState.TextureState p_i225995_1_, RenderState.TransparencyState p_i225995_2_, RenderState.DiffuseLightingState p_i225995_3_, RenderState.ShadeModelState p_i225995_4_, RenderState.AlphaState p_i225995_5_, RenderState.DepthTestState p_i225995_6_, RenderState.CullState p_i225995_7_, RenderState.LightmapState p_i225995_8_, RenderState.OverlayState p_i225995_9_, RenderState.FogState p_i225995_10_, RenderState.LayerState p_i225995_11_, RenderState.TargetState p_i225995_12_, RenderState.TexturingState p_i225995_13_, RenderState.WriteMaskState p_i225995_14_, RenderState.LineState p_i225995_15_, boolean p_i225995_16_) {
         this.texture = p_i225995_1_;
         this.transparency = p_i225995_2_;
         this.diffuseLighting = p_i225995_3_;
         this.shadowModel = p_i225995_4_;
         this.alpha = p_i225995_5_;
         this.depthTest = p_i225995_6_;
         this.cull = p_i225995_7_;
         this.lightmap = p_i225995_8_;
         this.overlay = p_i225995_9_;
         this.fog = p_i225995_10_;
         this.layer = p_i225995_11_;
         this.target = p_i225995_12_;
         this.texturing = p_i225995_13_;
         this.writeMask = p_i225995_14_;
         this.line = p_i225995_15_;
         this.outline = p_i225995_16_;
   ...
   static final class Type extends RenderType {
      ...
      private Type(String p_i225993_1_, VertexFormat p_i225993_2_, int p_i225993_3_, int p_i225993_4_, boolean p_i225993_5_, boolean p_i225993_6_, RenderType.State p_i225993_7_) {
         ...
         this.outlineRenderType = p_i225993_7_.outline ? p_i225993_7_.texture.func_228606_c_().map(RenderType::getOutline) : Optional.empty();
