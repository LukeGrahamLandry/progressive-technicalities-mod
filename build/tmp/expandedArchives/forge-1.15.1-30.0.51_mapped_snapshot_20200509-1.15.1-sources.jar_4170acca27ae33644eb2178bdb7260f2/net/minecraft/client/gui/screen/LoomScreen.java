...
public class LoomScreen extends ContainerScreen<LoomContainer> {
   ...
   protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
      ...
      if (this.field_228189_n_ != null && !this.field_214125_w) {
         ...
         TileEntityRendererDispatcher.instance.renderItem(this.field_228189_n_, new MatrixStack());
   ...
   private void func_228190_b_(int p_228190_1_, int p_228190_2_, int p_228190_3_) {
      ...
      BannerTileEntityRenderer.func_228837_a_(bannertileentity, matrixstack, irendertypebuffer$impl, 15728880, OverlayTexture.NO_OVERLAY, this.field_228188_m_, ModelBakery.LOCATION_BANNER_BASE, true);
      matrixstack.pop();
